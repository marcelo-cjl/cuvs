...
echo "Compiling bench_vamana_build.cu ..."
/usr/local/cuda-12.6/bin/nvcc \
  ...
  bench_vamana_build.cu \
  -o bench_vamana_build

echo "Build done: ./bench_vamana_build"
echo ""
echo "Usage: ./bench_vamana_build [data_path] [graph_degree] [num_runs]"
echo "  Default: ./bench_vamana_build /home/ubuntu/data/cohere/cohere.fbin 32 1"
